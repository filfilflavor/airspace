...
\[T\left(c\odot\vec{\mathbf{u}}\right)=\begin{bmatrix}\log_{w}\left(\left(c\odot\vec{\mathbf{u}}\right)_{1}\right)\end{bmatrix}=\begin{bmatrix}\log_{w}\left(\left(u_{1}\right)^{c}\right)\end{bmatrix}=\begin{bmatrix}c\log_{w}\left(u_{1}\right)\end{bmatrix}=cT\left(\vec{\mathbf{u}}\right)\]
