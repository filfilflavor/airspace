...
Axiom 3 (*existence of zero vector*): there exists \(\vec{\textbf{0}}\in V\) such that \(\vec{\textbf{u}}\oplus\vec{\textbf{0}}=\vec{\textbf{u}}=\vec{\textbf{0}}\oplus\vec{\textbf{u}}\) for all \(\vec{\textbf{u}}\in V\)
